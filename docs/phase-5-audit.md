...
| Full crash/fault matrix | 局部证据 | 各主协议的 process SIGKILL；Manifest/CURRENT、Journal、Active Data 主写、Data GC trash/delete、Active Mapping/rotation/GC 的 syscall-error matrix | Active Data create/tail、Initialize、Backup/Restore 尚未闭合；没有 power-loss 设备证据 |
