...
v1 协议。`metrics/prometheus`、long-fuzz runner 与 soak harness 已按 v2 runtime 重新实现；Migration
仍需生成 v2 原生版本。
...
production-ready：Migration、long-fuzz/72h soak 自然结束证据、真实 workload 基线和远端备份传输是后续完整性工作。
