...
var (
	...
	ErrSegmentMissing   = errors.New("recordlog: segment missing")
	ErrSegmentRetiring  = errors.New("recordlog: segment retiring")
	ErrReadersActive    = errors.New("recordlog: segment readers active")
	ErrCorrupt          = errors.New("recordlog: corrupt data")
	ErrUnsupported      = errors.New("recordlog: unsupported format")
	ErrRecoveryRequired = errors.New("recordlog: recovery required")
)
